                            ...
                            <tbody>
                                ...
                                foreach ($data as $us) {
                                    if ($us['rol'] == 1) {
                                        ...
                                        $rol = '<span class="badge-info p-1 rounded">Estudiante</span>';
                                    } elseif ($us['rol'] == 4) {
                                        $rol = '<span class="badge-warning p-1 rounded">Docente</span>';
                                    } else {
                                        $rol = '<span class="badge-dark p-1 rounded">Extra</span>';
                                    }
                                    if ($us['estado'] == 1) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select id="rol" class="form-control" name="rol">
                                    ...
                                    <option value="4">Docente</option> <!-- Nueva opción para Docente -->
                                    <option value="5">Extra</option> <!-- Nueva opción para Extra -->
                                </select>
                            </div>
                        </div>
                    </div>
